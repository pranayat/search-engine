...
public class ExampleAds {
	...
	public static void insertExampleAds() {
		...
		String text = "Unser Übungsbetrieb funktioniert nur, wenn wir genügend motivierte und gut qualifizierte Übungsleiter an unserem Fachbereich haben. Deshalb suchen wir Sie! Bewerben Sie sich jetzt!";
		String iurl = "https://www.mathematik.uni-kl.de/fileadmin/_processed_/a/4/csm_Lossen_1_zu_1_9ea7dd430c.jpg";
		Set <String> ngrams = Set.<String>of("übungsleiter", "lehre","übungsbetrieb","job","bewerben");
		...
		ngrams = Set.<String>of("instructor", "teaching","apply","job","offers");
		budget = (float)6.0;
		onclick = (float)0.05;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		iurl = "";
		ngrams = Set.<String>of("module handbook", "teaching","study","degree");
		budget = (float)20.0;
		onclick = (float)0.01;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		iurl = "";
		ngrams = Set.<String>of("computer science", "job","sci");
		budget = (float)5.0;
		onclick = (float)0.01;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		iurl = "";
		ngrams = Set.<String>of("computer science", "degree");
		budget = (float)1;
		onclick = (float)0.2;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		ngrams = Set.<String>of("computer science", "equipment");
		budget = (float)1;
		onclick = (float)0.1;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		iurl = "";
		ngrams = Set.<String>of("computer science", "project", "db", "dbislab");
		budget = (float)6;
		onclick = (float)0.2;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		ngrams = Set.<String>of("computer science", "literature","information systems", "dbislab");
		budget = (float)1.0;
		onclick = (float)0.3;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		ngrams = Set.<String>of("computer science", "database systems", "information systems", "dbislab", "teaching", "bachelor thesis", "master thesis");
		budget = (float)10.0;
		onclick = (float)0.01;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		ngrams = Set.<String>of("afterwork","sport","swimming", "unisport", "tukl");
		budget = (float)10.0;
		onclick = (float)0.05;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
		...
		ngrams = Set.<String>of("computer science", "e sports", "free time", "afterwork", "fun", "unisport");
		budget = (float)2.0;
		onclick = (float)0.5;
		language = "eng";
		insertAd(firstname, lastname, url, text, iurl,budget, onclick, ngrams, language);
